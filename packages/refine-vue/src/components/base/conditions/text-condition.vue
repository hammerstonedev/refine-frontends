<template>
  <renderless-text-condition :id="id || condition.id" :condition="condition" v-slot="{ clauses }">
    <base-condition
      :clauses="clauses"
...
import * as textClauseOptions from '../../../components/base/clause-options/text';

export default {
  name: 'text-condition',
  mixins: [conditionProps],
  defaultClauseOptions: { ...textClauseOptions },
  props: {
    value: {
      type: String,
      required: false,
